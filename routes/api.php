...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    // Route baru untuk fitur hari kerja
    Route::get('/get-working-days', [AttendanceController::class, 'getWorkingDays'])->name('get_working_days');
    Route::get('/check-day-allowed/{dayNumber}', [AttendanceController::class, 'checkDayAllowed'])->name('check_day_allowed');
