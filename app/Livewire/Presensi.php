...
class Presensi extends Component
{
    ...
    public function store() 
    {
        ...
        if ($schedule && !$schedule->isAllowedToday()) {
            $allowedDays = implode(', ', $schedule->getAllowedDaysNames());
            session()->flash('error', "Anda tidak dapat melakukan presensi hari ini. Hari yang diizinkan: {$allowedDays}");
            return;
        }
